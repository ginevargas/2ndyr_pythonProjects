# Learning Task (Dynamic Programming)
...
def main():
    ...
    v = [500, 100, 250, 250, 300, 350, 100, 150, 250, 200] # values / endorphin level
    w = [500, 300, 250, 400, 300, 350, 150, 500, 100, 400]  # weights / length(sec)
    c = 5000  # capacity
